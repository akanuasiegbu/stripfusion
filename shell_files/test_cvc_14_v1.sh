...
# yolov5l_cvc14_with_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_1_tstride_1_lframe_fixed_kl_div_cvc14_use_only_rgb_anns_verify_again
...
python test_video.py \
 --weights ./runs/train/yolov5l_cvc14_with_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_1_tstride_1_lframe_fixed_kl_div_cvc14_use_only_rgb_anns_verify_again/weights/cur_39.pt \
 ...
 --name percentage_yolov5l_cvc14_with_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_1_tstride_1_lframe_fixed_kl_div_cvc14_use_only_rgb_anns_verify_again \
 --lframe 1 \
 --temporal_stride 1 \
 --gframe 0 \
 --regex_search .set...V... \
...
python test_video.py \
 --weights ./runs/train/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_3_lframe/weights/cur_39.pt \
 --data  ./data/multispectral_temporal/cvc14_video_test_resizedv2.yaml  \
 --cfg ./models/transformer/two_detection_heads/ind_fusion_heads/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_KLBackNL_full.yaml \
 --name percentage_yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_3_lframe \
 --lframe 3 \
 --temporal_stride 3 \
 --gframe 0 \
 --regex_search .set...V... \
...
python test_video.py \
 ...
 --data  ./data/multispectral_temporal/cvc14_video_test_resizedv2.yaml  \
 --cfg ./models/transformer/two_detection_heads/ind_fusion_heads/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_KLBackNL_full.yaml \
 --name percentage_yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_5_lframe \
 --batch-size 32 \
 --lframe 5 \
 --temporal_stride 3 \
 --gframe 0 \
...
python test_video.py \
 ...
 --data  ./data/multispectral_temporal/cvc14_video_test_resizedv2.yaml  \
 --cfg ./models/transformer/two_detection_heads/ind_fusion_heads/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_KLBackNL_full.yaml \
 --name percentage_yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_7_lframe \
 --batch-size 32 \
 --lframe 7 \
 --temporal_stride 3 \
 --gframe 0 \
...
python test_video.py \
 ...
 --data  ./data/multispectral_temporal/cvc14_video_test_resizedv2.yaml  \
 --cfg ./models/transformer/two_detection_heads/ind_fusion_heads/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_KLBackNL_full.yaml \
 --name percentage_yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_5_tstride_7_lframe \
 --batch-size 32 \
 --lframe 7 \
 --temporal_stride 5 \
 --gframe 0 \
