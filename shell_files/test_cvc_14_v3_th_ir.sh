...
--batch-size 32 \
--weights runs/train/yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_5_lframe_seed_three_hundred/weights/cur_39.pt \
...
--name yolov5l_cvc14_tadaconv_stripmlpSTmixv2_lastframe_2DH_without_kl_div_freeze3_init_bb_both_heads_iR_R_iT_freezeT_3_tstride_5_lframe_seed_three_hundred \
--lframe 5 \
--temporal_stride 3 \
--gframe 0 \
--regex_search .set...V... \
